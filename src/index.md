...
<a class="vcard__link with-icon" href="https://codepen.io/seezee" rel="me"><svg class="icon icon--codepen" role="img" aria-hidden="true" width="24" height="24"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#icon-codepen"></use></svg><span class="vcard__link-text p-nickname">@seezee</span><span class="sr-only"> on Codepen</span></a> {.vcard__social-item}
